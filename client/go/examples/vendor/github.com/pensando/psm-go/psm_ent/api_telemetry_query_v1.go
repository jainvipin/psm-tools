...
type ApiTelemetry_queryGetSQLQuery1Request struct {
	ctx _context.Context
	ApiService *TelemetryQueryV1ApiService
	tenant *string
}

func (r ApiTelemetry_queryGetSQLQuery1Request) Tenant(tenant string) ApiTelemetry_queryGetSQLQuery1Request {
	r.tenant = &tenant
	return r
}

func (r ApiTelemetry_queryGetSQLQuery1Request) Execute() (TelemetryQueryMetricsQueryResponse, *_nethttp.Response, error) {
	return r.ApiService.GetSQLQuery1Execute(r)
}

/*
 * GetSQLQuery1 Method for GetSQLQuery1
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiTelemetry_queryGetSQLQuery1Request
 */
func (a *TelemetryQueryV1ApiService) GetSQLQuery1(ctx _context.Context) ApiTelemetry_queryGetSQLQuery1Request {
	return ApiTelemetry_queryGetSQLQuery1Request{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return TelemetryQueryMetricsQueryResponse
 */
func (a *TelemetryQueryV1ApiService) GetSQLQuery1Execute(r ApiTelemetry_queryGetSQLQuery1Request) (TelemetryQueryMetricsQueryResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TelemetryQueryV1ApiService.GetSQLQuery1")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/telemetry/v1/sqlmetrics"
	...
	if localVarHTTPResponse.StatusCode == 401 {
		a.client.cfg.PSMCfg.Login()
		a.client.cfg.PSMCfg.SaveConfig()
		return a.GetSQLQuery1Execute(r)
	}
...
type ApiTelemetry_queryPostSQLQueryRequest struct {
	ctx _context.Context
	ApiService *TelemetryQueryV1ApiService
	body *TelemetryQueryMetricsSQLQuery
}

func (r ApiTelemetry_queryPostSQLQueryRequest) Body(body TelemetryQueryMetricsSQLQuery) ApiTelemetry_queryPostSQLQueryRequest {
	r.body = &body
	return r
}

func (r ApiTelemetry_queryPostSQLQueryRequest) Execute() (TelemetryQueryMetricsQueryResponse, *_nethttp.Response, error) {
	return r.ApiService.PostSQLQueryExecute(r)
}

/*
 * PostSQLQuery Method for PostSQLQuery
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiTelemetry_queryPostSQLQueryRequest
 */
func (a *TelemetryQueryV1ApiService) PostSQLQuery(ctx _context.Context) ApiTelemetry_queryPostSQLQueryRequest {
	return ApiTelemetry_queryPostSQLQueryRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return TelemetryQueryMetricsQueryResponse
 */
func (a *TelemetryQueryV1ApiService) PostSQLQueryExecute(r ApiTelemetry_queryPostSQLQueryRequest) (TelemetryQueryMetricsQueryResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TelemetryQueryV1ApiService.PostSQLQuery")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	if localVarHTTPResponse.StatusCode == 401 {
		a.client.cfg.PSMCfg.Login()
		a.client.cfg.PSMCfg.SaveConfig()
		return a.PostSQLQueryExecute(r)
	}
